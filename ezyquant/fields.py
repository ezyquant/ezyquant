...
MARKET_MAP = {MARKET_SET: "A", MARKET_MAI: "S", MARKET_BOND: "B"}
...
DAILY_STOCK_TRADE_FACTOR = {
    # "trade": "D_TRADE",
    # "security": "I_SECURITY",
    # "trading_method": "I_TRADING_METHOD",
    # "trade_report": "I_TRADE_REPORT",
    # "market": "I_MARKET",  # 'A':'SET','S':'MAI'
    "prior": "Z_PRIOR",  # last_close
    "open": "Z_OPEN",
    "high": "Z_HIGH",
    "low": "Z_LOW",
    "close": "Z_CLOSE",
    "average": "Z_AVERAGE",
    "last_bid": "Z_LAST_BID",
    "last_offer": "Z_LAST_OFFER",
    "trans": "Q_TRANS",  # number of transactions
    "volume": "Q_VOLUME",
    "value": "M_VALUE",
}
DAILY_STOCK_STAT_FACTOR = {
    # "trade": "D_TRADE",
    # "security": "I_SECURITY",
    # "market": "I_MARKET",  # 'A':'SET','S':'MAI'
    # "industry": "I_INDUSTRY",
    # "sector": "I_SECTOR",
    # "subsector": "I_SUBSECTOR",
    "pe": "R_PE",
    "pb": "R_PB",
    "par": "Z_PAR",
    "dps": "R_DPS",
    ...
    "month_dvd": "Q_MONTH_DVD",
    "as_of": "D_AS_OF",
    "dividend": "D_DIVIDEND",  # last_dividend
    "status": "N_STATUS",
    "benefit": "N_BENEFIT",
    ...
    "roi": "R_ROI",
    "acc_dps": "R_ACC_DPS",
    "dvd_payment": "Q_DVD_PAYMENT",
    "dvd_payout": "R_DVD_PAYOUT",
    "earning": "D_EARNING",
    "iv": "R_IV",
    "delta": "R_DELTA",
    "notice": "F_NOTICE",
    "non_compliance": "F_NON_COMPLIANCE",
