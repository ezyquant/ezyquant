...
class TestCostPrice:
    ...
    def test_buy(
        ...
        p1 = Position(symbol="A", volume=volume1, cost_price=price1)
        result1 = p1.place_order(volume=volume2, price=price2)

        p2 = Position(symbol="A", volume=volume2, cost_price=price2)
        result2 = p2.place_order(volume=volume1, price=price1)
    ...
    def test_buy_same_price(
        ...
        p = Position(symbol="A", volume=volume1, cost_price=price)

        result = p.place_order(volume=volume2, price=price)
    ...
    def test_sell(
        ...
        p = Position(symbol="A", volume=volume1, cost_price=price1)

        result = p.place_order(volume=volume2, price=price2)
